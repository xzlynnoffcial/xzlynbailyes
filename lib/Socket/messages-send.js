...
const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        sendGroupMentionedStatus: async (groupJid, content, options = {}) => {
            ...
            const font = !isMedia ? content.font : undefined;
            ...
            const innerMsg = await (0, Utils_1.generateWAMessage)('status@broadcast', {
                ...content,
                mentions: [groupJid], // memunculkan '@ Nama Grup' di UI
            }, {
                userJid,
                font,
                backgroundColor,
            ...
            // 2. Kirim notifikasi 'groupStatusMentionMessage' ke grup tersebut
            ...
            const statusNotifMsg = await (0, Utils_1.generateWAMessageFromContent)(groupJid, protocolMessage, {});
            await relayMessage(groupJid, statusNotifMsg.message, {
