...
const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        sendGroupMentionedStatus: async (groupJid, content, options = {}) => {
            ...
            const ownJid = (0, Utils_1.jidNormalizedUser)(userJid);
            const viewerSet = new Set(statusJidList.map(j => (0, Utils_1.jidNormalizedUser)(j)));
            ...
            await relayMessage('status@broadcast', msgObj, {
                ...
                additionalNodes: [{
                    ...
                    content: [{
                        ...
                        content: [{
                            tag: 'to',
                            attrs: { jid: (0, Utils_1.jidNormalizedUser)(groupJid) }
                        }]
                    }]
                }]
            });
