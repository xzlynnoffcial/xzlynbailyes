...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('interactiveButtons' in message && !!message.interactiveButtons) {
        const normalizedButtons = message.interactiveButtons.map(btn => {
            let name = typeof btn.name === 'string' ? btn.name.toLowerCase() : '';
            if (name === 'quickreply') name = 'quick_reply';
            else if (name === 'ctaurl') name = 'cta_url';
            else if (name === 'ctacall') name = 'cta_call';
            else if (name === 'ctacatalog') name = 'cta_catalog';
            else if (name === 'reviewandpay') name = 'review_and_pay';
            else if (name === 'sendlocation') name = 'send_location';
            ...
            if (typeof params === 'string') {
                try {
                    ...
                    for (let key in parsed) {
                        ...
                        if (lowerKey === 'displaytext') newParams['display_text'] = parsed[key];
                        else if (lowerKey === 'merchanturl') newParams['merchant_url'] = parsed[key];
                        else if (lowerKey === 'phonenumber') newParams['phone_number'] = parsed[key];
                        else if (lowerKey === 'copycode') newParams['copy_code'] = parsed[key];
                        else newParams[key] = parsed[key];
                    }
    ...
    if (('viewOnce' in message && !!message.viewOnce) || ('viewonce' in message && !!message.viewonce)) {
