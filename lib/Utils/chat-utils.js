...
const processSyncAction = (syncAction, ev, me, initialSyncOpts, logger) => {
    ...
    if (action === null || action === void 0 ? void 0 : action.muteAction) {
        ...
        if (action.contactAction.lidJid && id) (0, WABinary_1.registerLidJid)(action.contactAction.lidJid, id);
        if (action.contactAction.lidJid && action.contactAction.pnJid) (0, WABinary_1.registerLidJid)(action.contactAction.lidJid, action.contactAction.pnJid);
    }
